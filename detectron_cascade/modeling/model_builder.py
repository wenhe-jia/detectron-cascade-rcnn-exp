...
from detectron_cascade.modeling.detector import DetectionModelHelper
from detectron_cascade.roi_data.loader import RoIDataLoader
import detectron_cascade.modeling.fast_rcnn_heads as fast_rcnn_heads
import detectron_cascade.modeling.keypoint_rcnn_heads as keypoint_rcnn_heads
import detectron_cascade.modeling.mask_rcnn_heads as mask_rcnn_heads
import detectron_cascade.modeling.name_compat as name_compat
import detectron_cascade.modeling.optimizer as optim
import detectron_cascade.modeling.retinanet_heads as retinanet_heads
import detectron_cascade.modeling.rfcn_heads as rfcn_heads
import detectron_cascade.modeling.rpn_heads as rpn_heads
import detectron_cascade.roi_data.minibatch as roi_data_minibatch
import detectron_cascade.utils.c2 as c2_utils
...
def get_func(func_name):
    ...
    try:
        ...
        module_name = 'detectron_cascade.modeling.' + '.'.join(parts[:-1])
...
import detectron_cascade.modeling.ResNet as ResNet
import detectron_cascade.modeling.VGG16 as VGG16
import detectron_cascade.modeling.VGG_CNN_M_1024 as VGG_CNN_M_1024
