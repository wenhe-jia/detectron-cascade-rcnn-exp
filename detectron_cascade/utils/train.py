...
from detectron_cascade.datasets.roidb import combined_roidb_for_training
# for Detectron with cascade rcnn , import model builder from cascade_rcnn folder,
# for org Detectron, import model builder from modeling folder
from detectron_cascade.modeling import model_builder
from detectron_cascade.utils import lr_policy
from detectron_cascade.utils.training_stats import TrainingStats
import detectron_cascade.utils.env as envu
import detectron_cascade.utils.net as nu
...
def train_model():
    ...
    # graph = net_drawer.GetPydotGraph(model.net, "train", rankdir="TD")
    # graph.write_png('cascade_rcnn_net.png')
